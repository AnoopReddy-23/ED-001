...
export default function CardSettings() {
  ...
  const onFormSubmit=(userCredObj)=>{
    ...
    axios.post('/add-assignment',userCredObj)
    .then(res=>{
              ...
              <Form.Group className="mb-3">
                <Form.Label>SELECT TYPE OF ASSIGNMENT</Form.Label> <br />
                  <Form.Check inline type="radio" id="canva">
                    <Form.Check.Input type="radio" value="canva" {...register("type", { required: true })} />
                  <Form.Check.Label>Canva Presentation</Form.Check.Label>
                </Form.Check>
                
                <Form.Check inline type="radio" id="audio">
                  <Form.Check.Input type="radio" value="audio" {...register("type", { required: true })}/>
                  <Form.Check.Label>Audio Files</Form.Check.Label>
                </Form.Check>

                <Form.Check inline type="radio" id="ppt">
                  <Form.Check.Input type="radio" value="ppt" {...register("type", { required: true })}/>
